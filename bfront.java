...
class bfront extends JFrame{
 //六個JLabel標籤物件，分別姓名\年齡\性別\興趣\學歷\居住地區\
	JLabel lblName, lblAge, lblSex, lbllnter, lblAcad, lblPlace;
...
bfront(){
	...
	//JCheckBox核對方塊元件
	lbllnter = new JLabel("興趣 : ");
	lbllnter.setBounds(10,70,50,20);
	pane.add(lbllnter);
